...
@section('container')
    <div class="d-flex-column align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">Edit Customer Data {{ $data->name}} </h1>
    </div>
            ...
            <form action="{{ route('customer.update', $data->id) }}" method="POST">
                ...
                <div>
                    ...
                    <div class="input-group mb-3 w-50">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $data->name }}" id="customer-name" name="name" autofocus>
                        @error('name')
                ...
                <div>
                    ...
                    <div class="input-group mb-3 w-50">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{$data->email }}" id="customer-email" name="email">
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
